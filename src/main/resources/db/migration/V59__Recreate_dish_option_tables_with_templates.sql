-- V59: Replace simple dish_option tables (V58) with the 3-layer template system.
-- Drop old V58 tables if they exist (order matters due to FK).
DROP TABLE IF EXISTS order_item_options CASCADE;
DROP TABLE IF EXISTS dish_option_items CASCADE;
DROP TABLE IF EXISTS dish_option_groups CASCADE;

-- Also drop new tables in case of partial re-run
DROP TABLE IF EXISTS option_item_templates CASCADE;
DROP TABLE IF EXISTS option_group_templates CASCADE;
